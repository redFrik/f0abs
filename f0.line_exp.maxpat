...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "expr ln(abs($f1-$f3+1))/ln(abs($f2)+1)*abs($f2)+$f3",
					"numinlets" : 3,
					"fontname" : "Monaco",
					"numoutlets" : 1,
					"patching_rect" : [ 118.0, 504.0, 286.0, 19.0 ],
					"outlettype" : [ "" ],
					"id" : "obj-39",
					"fontsize" : 9.0
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "expr pow(abs($f2+1)\\,($f1-$f3)/abs($f2))*$f2+abs(($f3-$f2))",
					"numinlets" : 3,
					"fontname" : "Monaco",
					"numoutlets" : 1,
					"patching_rect" : [ 90.0, 473.0, 329.0, 19.0 ],
					"outlettype" : [ "" ],
					"id" : "obj-40",
					"fontsize" : 9.0
				}
