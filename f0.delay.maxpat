...
,
		"rect" : [ 10.0, 59.0, 232.0, 329.0 ],
		"bglocked" : 0,
		"defrect" : [ 10.0, 59.0, 232.0, 329.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"fontname" : "Monaco",
					"numoutlets" : 1,
					"patching_rect" : [ 22.0, 234.0, 65.0, 19.0 ],
					"outlettype" : [ "" ],
					"id" : "obj-1",
					"fontsize" : 9.0
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Monaco",
					"numoutlets" : 2,
					"patching_rect" : [ 163.0, 154.0, 38.0, 19.0 ],
					"outlettype" : [ "bang", "" ],
					"id" : "obj-3",
					"fontsize" : 9.0
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "anything to delay",
					"numinlets" : 1,
					"fontname" : "Monaco",
					"numoutlets" : 0,
					"patching_rect" : [ 1.0, 22.0, 102.0, 19.0 ],
					"id" : "obj-5",
					"fontsize" : 9.0
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Monaco",
					"numoutlets" : 0,
					"patching_rect" : [ 121.0, 22.0, 70.0, 19.0 ],
					"id" : "obj-8",
					"fontsize" : 9.0
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Monaco",
					"numoutlets" : 1,
					"patching_rect" : [ 163.0, 118.0, 54.0, 19.0 ],
					"outlettype" : [ "bang" ],
					"id" : "obj-11",
					"fontsize" : 9.0
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Monaco",
					"numoutlets" : 1,
					"patching_rect" : [ 163.0, 137.0, 32.5, 17.0 ],
					"outlettype" : [ "" ],
					"id" : "obj-12",
					"fontsize" : 9.0
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Monaco",
					"numoutlets" : 1,
					"patching_rect" : [ 22.0, 106.0, 54.0, 19.0 ],
					"outlettype" : [ "" ],
					"id" : "obj-14",
					"fontsize" : 9.0
				}
