...
, 			{
				"box" : 				{
					...
					"fontname" : "Monaco",
					"numoutlets" : 0,
					"patching_rect" : [ 130.0, 210.0, 81.0, 19.0 ],
					"id" : "obj-8",
					"fontsize" : 9.0
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Monaco",
					"numoutlets" : 0,
					"patching_rect" : [ 120.0, 190.0, 59.0, 19.0 ],
					"id" : "obj-9",
					"fontsize" : 9.0
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "value+receive that remembers what has been received",
					"numinlets" : 1,
					"fontname" : "Monaco",
					"numoutlets" : 0,
					"patching_rect" : [ 20.0, 50.0, 286.0, 19.0 ],
					"id" : "obj-11",
					"fontsize" : 9.0
				}
