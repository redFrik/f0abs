...
,
		"rect" : [ 256.0, 44.0, 332.0, 284.0 ],
		"bglocked" : 0,
		"defrect" : [ 256.0, 44.0, 332.0, 284.0 ],
...
, 			{
				"box" : 				{
					...
					"fontname" : "Monaco",
					"numoutlets" : 0,
					"patching_rect" : [ 140.0, 90.0, 75.0, 19.0 ],
					"id" : "obj-2",
					"fontsize" : 9.0
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Monaco",
					"numoutlets" : 2,
					"patching_rect" : [ 70.0, 210.0, 35.0, 19.0 ],
					"outlettype" : [ "int", "bang" ],
					"id" : "obj-4",
					"fontsize" : 9.0,
...
, 			{
				"box" : 				{
					...
					"fontname" : "Monaco",
					"numoutlets" : 4,
					"patching_rect" : [ 70.0, 130.0, 73.0, 19.0 ],
					"outlettype" : [ "int", "", "", "int" ],
					"id" : "obj-5",
					"fontsize" : 9.0
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Monaco",
					"numoutlets" : 2,
					"patching_rect" : [ 70.0, 150.0, 35.0, 19.0 ],
					"outlettype" : [ "int", "bang" ],
					"id" : "obj-7",
					"fontsize" : 9.0,
					"htextcolor" : [ 0.870588, 0.870588, 0.870588, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"fontname" : "Monaco",
					"numoutlets" : 0,
					"patching_rect" : [ 150.0, 200.0, 119.0, 19.0 ],
					"id" : "obj-8",
					"fontsize" : 9.0
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "fifo delay line for messages",
					"numinlets" : 1,
					"fontname" : "Monaco",
					"numoutlets" : 0,
					"patching_rect" : [ 80.0, 50.0, 162.0, 19.0 ],
					"id" : "obj-11",
					"fontsize" : 9.0
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Monaco",
					"numoutlets" : 1,
					"patching_rect" : [ 70.0, 170.0, 70.0, 19.0 ],
					"outlettype" : [ "" ],
					"id" : "obj-13",
					"fontsize" : 9.0
				}
