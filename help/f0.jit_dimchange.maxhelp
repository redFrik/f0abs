...
,
		"rect" : [ 256.0, 44.0, 346.0, 365.0 ],
		"bglocked" : 0,
		"defrect" : [ 256.0, 44.0, 346.0, 365.0 ],
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "works with any number of dimensions",
					"numinlets" : 1,
					"fontname" : "Monaco",
					"numoutlets" : 0,
					"patching_rect" : [ 40.0, 70.0, 200.0, 19.0 ],
					"id" : "obj-3",
					"fontsize" : 9.0
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Monaco",
					"numoutlets" : 1,
					"patching_rect" : [ 50.0, 300.0, 71.0, 17.0 ],
					"outlettype" : [ "" ],
					"id" : "obj-4",
					"fontsize" : 9.0
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Monaco",
					"numoutlets" : 1,
					"patching_rect" : [ 50.0, 240.0, 97.0, 19.0 ],
					"outlettype" : [ "" ],
					"id" : "obj-12",
					"fontsize" : 9.0
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Monaco",
					"numoutlets" : 0,
					"patching_rect" : [ 310.0, 340.0, 27.0, 19.0 ],
					"id" : "obj-13",
					"fontsize" : 9.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 200.0, 210.0, 137.0, 151.0 ],
					"pic" : "f0logo.png",
					"id" : "obj-14"
				}
